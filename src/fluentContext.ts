...
function withData<TLogger extends Logger>(
  this: TLogger,
  data: Context
): TLogger {
...
function withContext<TLogger extends Logger>(
  this: TLogger,
  context: Context
): TLogger {
...
export function addFluentContext<TLogger extends Logger>(
  target: TLogger
): TLogger & FluentContext {
